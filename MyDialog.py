...
class SetRemoteDialog(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        grid.addWidget(QtGui.QLabel(u'remote db url[123.57.188.226/]', parent=self), 1, 0, 1, 1)
        ...
        grid.addWidget(QtGui.QLabel(u'remote db url[123.57.188.226/]', parent=self), 2, 0, 1, 1)
        self.remote_url_line = QtGui.QLineEdit(parent=self)
        self.remote_url_line.setText('123.57.188.226/')
